...
class BossService:
        ...
        *,
        ...
        for iteration in range(max_iterations):
            ...
            try:
                ...
                synthesized = self._synthesize(last_result, fallback_feedback)
            ...
            if decision.decision is BossDecisionType.SYNTHESIZE:
                synthesized = self._synthesize(last_result, critic_feedback)
                return ActorCriticBossResult(
                    final_result=synthesized,
                    iterations=iterations,
                    converged=False,
        ...
        synthesized = self._synthesize(last_result, critic_feedback)  # type: ignore[arg-type]
        return ActorCriticBossResult(
            final_result=synthesized,
            iterations=iterations,
            converged=False,
    ...
    def _synthesize(
        self, last_result: EstimationResult, feedback: CriticFeedback
    ) -> EstimationResult:
