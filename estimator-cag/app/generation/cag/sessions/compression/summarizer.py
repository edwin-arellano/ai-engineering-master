...
from app.foundations.prompts.loader import render_summarizer_prompt
    ...
    def summarize(
        ...
        *,
        ...
        try:
            ...
            # vive en `app.domain.session` para mantener Instructor en una
            # sola capa de schemas.
            from app.domain.session import _SummaryEnvelope
