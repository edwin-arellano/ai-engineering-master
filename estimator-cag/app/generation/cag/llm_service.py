...
from app.generation.cag.guardrails import validate_input
from app.foundations.prompts.loader import render_estimation_prompt
from app.domain.actor_critic_boss import ActorCriticBossResult, CriticFeedback
from app.domain.estimation import EstimationResponse, EstimationResult
from app.domain.session import EstimationMode, Session
from app.domain.tier import UserTier
from app.generation.agentic import BossService
from app.generation.cag.attachments import ExtractedAttachment, build_attachments_block
from app.generation.cag.metadata_extractor import extract_metadata_update
from app.generation.cag.sessions import SessionStore
from app.generation.cag.sessions.compression import apply_compression
from app.generation.cag.tiers import TierContext, get_tier_resolver
