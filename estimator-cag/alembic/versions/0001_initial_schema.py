"""initial schema: vector extension + documents + chunks

Revision ID: 0001
Revises:
Create Date: pre-session-08
"""
...
def upgrade():
    ...
    # NOTA: deliberadamente NO se crea índice vectorial (HNSW/IVFFlat). Eso es el directo.
